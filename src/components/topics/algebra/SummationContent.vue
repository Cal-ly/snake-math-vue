<template>
  ...
  <!-- Term Breakdown and Analysis Card -->
  <div class="card mb-4">
    <div class="card-header">
      <h3 class="h5 mb-0"><i class="fas fa-list-ol me-2"></i>Term Breakdown & Analysis</h3>
    </div>
    <div class="card-body">
      <div class="row g-4">
        <div class="col-md-6">
          <h6>Individual Terms:</h6>
